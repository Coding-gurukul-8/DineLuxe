export default function Loading() {
  return (
    <div className="flex min-h-screen items-center justify-center p-8">
      <div className="w-full max-w-md space-y-4 rounded-md border border-ink/10 bg-paper/90 p-8 shadow-soft">
        ...
        <div className="h-10 w-full animate-pulse rounded-md bg-ink/10" />
      </div>
    </div>
  )
}
