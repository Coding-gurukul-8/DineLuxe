    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full max-w-md">
        ...
        <motion.div variants={itemVariants} className="text-center mb-8">
          ...
          <h1 className="font-['Playfair_Display',Georgia,serif] text-3xl text-[#1A3C5E] mb-1.5">Admin registration</h1>
          <p className="text-sm text-[#1A3C5E]/45 tracking-wide">Invite-only — platform administrator account</p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-6 pt-5 border-t border-[#1A3C5E]/6 text-center">
            <p className="text-sm text-[#1A3C5E]/40">
              ...
              <Link href="/auth/admin" className="text-[#E8A020] font-medium hover:underline">Sign in</Link>
            </p>
          </div>
        </motion.div>
