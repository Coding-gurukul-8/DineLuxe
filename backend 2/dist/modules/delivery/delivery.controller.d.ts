...
export declare function handleAssignDelivery(req: Request, res: Response, next: NextFunction): Promise<void>;
export declare function handleGetDelivery(req: Request, res: Response, next: NextFunction): Promise<void>;
export declare function handleUpdateDeliveryStatus(req: Request, res: Response, next: NextFunction): Promise<void>;
