...
// POST /inventory
router.post('/', (0, rbac_middleware_1.requireRole)('manager', 'owner'), (0, validate_middleware_1.validate)(inventory_schema_1.createInventorySchema), inventory_controller_1.createInventory);
...
router.post('/deduct', (0, rbac_middleware_1.requireRole)('manager', 'owner'), (0, validate_middleware_1.validate)(inventory_schema_1.deductInventorySchema), inventory_controller_1.deductInventory);
// POST /inventory/waste-log
router.post('/waste-log', (0, rbac_middleware_1.requireRole)('manager', 'owner'), (0, validate_middleware_1.validate)(inventory_schema_1.wasteLogSchema), inventory_controller_1.wasteLog);
